...
/**
     ...
     * See the License for the specific language governing permissions and
     * limitations under the License.
     */class d{static get isIOS(){return/iP(hone|ad)/i.test(navigator.platform)||"MacIntel"===navigator.platform&&navigator.maxTouchPoints>1}static requireOrientationPermission(){return void 0!==window.DeviceOrientationEvent&&"function"==typeof window.DeviceOrientationEvent.requestPermission}static requestOrientationPermissions(){return window.DeviceOrientationEvent.requestPermission()}}class p{static get fullScreenAvailable(){return document.fullscreenEnabled||document.mozFullscreenEnabled||document.webkitFullscreenEnabled||document.msFullscreenEnabled}static get isIOS(){return d.isIOS}static get IOSFullscreenAvailable(){return d.isIOS&&this.fullScreenAvailable}static get pipSupported(){return c.supported}}const m="requestVideoFrameCallback"in HTMLVideoElement.prototype,v=window.requestAnimationFrame||window.mozRequestAnimationFrame||window.webkitRequestAnimationFrame||window.msRequestAnimationFrame,g=window.cancelAnimationFrame||window.mozCancelAnimationFrame;let b;return e.CanvasPipFullscreen=class extends i{constructor(e,t,i=!1){super(),this._canvas=e,this._video=t,this._requiresDom=!1,this._forceFs=i}async init(){return new Promise((e=>{this.initCanvasVideo();const t=p.isIOS,i=p.pipSupported;i&&this.initPip(),this._requiresDom=t&&i,!t||p.fullScreenAvailable&&!this._forceFs||(this._requiresDom=!0,this.initFullscreen()),e(this._requiresDom)}))}static get pipSupported(){return p.pipSupported}static get fullScreenAvailable(){return p.fullScreenAvailable}get requiresDom(){return this._requiresDom}initCanvasVideo(){(this._canvasVideo=document.createElement("video")).setAttribute("autoplay",!0)}initPip(){this.canvasPip=new u(this._canvas,this._video,this._canvasVideo);const e=(e,...t)=>{this.emit(e.type,t[0],t[1])};this.canvasPip.on("enterpictureinpicture",e).on("leavepictureinpicture",e).on("failed",e).on("disabled",e),this.canvasPip.init()}initFullscreen(){const e=(e,...t)=>{this.emit(e.type,t[0],t[1])};this.canvasFullScreen=new h(this._canvas,this._canvasVideo),this.canvasFullScreen.on("webkitbeginfullscreen",e).on("webkitendfullscreen",e).on("fsplay",e).on("fspause",e)}set video(e){this.canvasPip&&(this.canvasPip.video=e)}get canvasVideo(){return this._canvasVideo}togglePictureInPicture(e=!0){this.canvasPip.togglePictureInPicture(e)}requestFullscreen(){this.canvasFullScreen&&this.canvasFullScreen.requestFullscreen()}exitFullscreen(){this.canvasFullScreen&&this.canvasFullScreen.exitFullscreen()}},e.CanvasPipFullscreenUtil=p,e.VideoAnimation=class{constructor(e,t){this.callback=e,this.video=t,this.animationID=null,this.running=!1}setCallback(e){this.callback=e}async animateLegacy(){const e=this.video.currentTime;e>b&&((1/(e-b)).toFixed(),await this.callback(e,{width:this.video.videoWidth,height:this.video.videoHeight})),b=e,this.animationID=v((async()=>await this.animateLegacy()))}async animate(e,t){await this.callback(e,t),this.video.requestVideoFrameCallback(this.animateRef)}initAnimate(){this.animateRef=async(e,t)=>await this.animate(e,t),this.video.requestVideoFrameCallback(this.animateRef)}initLegacyAnimate(){this.animateLegacy()}start(){this.stop(),m?this.initAnimate():(b=new Date,this.initLegacyAnimate()),this.running=!0}stop(){this.running=!1,m?this.animateRef=()=>{}:g(this.animationID&&this.animationID.data&&this.animationID.data.handleId||this.animationID)}},Object.defineProperty(e,"__esModule",{value:!0}),e}({});
